...
public class SecretBiddingFirstBidTest {
    ...
    public SecretBiddingFirstBidTest() {
    }
    ...
    @Before
    public void setUp() {
        strategyExecutor = new SecretBiddingFirstBid();
    ...
    /**
     * Test of electBestBidAndWinnerAndWinPrice method, of class SecretBiddingFirstBid.
     */
    @Test
    public void secretBiddingFirstBid_electBestBidAndWinnerAndWinPrice_ShouldWorkCorrectly() {
    ...
    @Test
    public void secretBiddingFirstBid_electBestBidAndWinnerAndWinPrice_OnEqualBidsShouldPickEarliest() throws ParseException {
        BidServiceModel winnigBid = allAuctionBids.get(3);
        winnigBid.setAmount(new BigDecimal(100));
